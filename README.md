...
## Operating Systems/Low-level Knowledge:
  ...
  4. https://book.easyperf.net/perf_book
...
## Mix of All/Other Resouces:
  ...
  Doing:
  1. BUILD BUILD BUILD, no better way to learn than to build your own projects focused on HFT i.e. Order Book implementation, order management system, your own MM bot etc (will hopefully make my ones public for learning purposes).
